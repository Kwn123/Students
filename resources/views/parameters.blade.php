            ...
            <div class="card-body">
                <form action="{{ route('parameterStore') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('promotion') is-invalid @enderror" id="promotion" name="promotion" value="{{ old('promotion') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('regular') is-invalid @enderror" id="regular" name="regular" value="{{ old('regular') }}">
